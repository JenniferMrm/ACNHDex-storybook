<template functional>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" :width="props.size" :height="props.height" :class="`icon-${props.color}`">
    <path
      class="icon-filled"
...
<script>
import iconsMixin from "@ui/components/icons/_icons-mixin";
